...
class _KerangjangScreens extends State<KerangjangScreens> {
                  ...
                  ListView.separated(
                    ...
                    itemBuilder: (context, index) {
                      return _keranjang(
                        ...
                        dataKerangjang[index]['jumlahBarang'],
                        index,
  ...
  Widget _keranjang(
      String gambar, String nama, harga, jumlahBarang, int index, id) {
                  ...
                  children: <Widget>[
                    Container(
                      ...
                      child: TextField(
                        ...
                        decoration: InputDecoration(
                            ...
                            hintText: 'Masukan Jumlah Barang Disini',
                    ...
                    Container(
                      ...
                      child: ElevatedButton(
                        onPressed: () {
                          var data = {'jumlahBarang': jmlBeliController.text};
      ...
      setState(() {
        ...
        if (status == true) {
          ...
          for (var i = 0; i < dataKerangjang.length; i++) {
            print(dataKerangjang[i]['jumlahBarang']);
            int jmlBeli = dataKerangjang[i]['jumlahBarang'];
